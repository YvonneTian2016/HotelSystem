...
void CdialogDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//DDX_LBString(pDX, IDC_LIST1, Current_Time1);
	DDX_Text(pDX, IDC_EDIT1, Current_Time);
}
...
ON_COMMAND(ID_32777, &CdialogDlg::Onprice_list)
ON_COMMAND(ID_32779, &CdialogDlg::OnRoomPrice)
...
void CdialogDlg::OnBnClickedFee()//**************已改为服务消费项目的按钮
{
	// TODO: 在此添加控件通知处理程序代码
...
void CdialogDlg::OnTimer(UINT_PTR nIDEvent)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
     COleDateTimeSpan time1(0,0,10,0);
	 //
	 
	 time2.operator +=(time1);
     Current_Time=time2.Format(_T("%Y-%m-%d %H:%M:%S"));
...
void CdialogDlg::OnBnClickedButton2()//团体入住登记
{
	// TODO: 在此添加控件通知处理程序代码
DazongZhu dlg;
dlg.Sethotel(&sit);
...
void CdialogDlg::OnBnClickedButton3()//团体退房
{
